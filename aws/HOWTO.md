...
[Zappa Settings](../../../Downloads/tr-05-serverless-have-i-been-pwned-develop/zappa_settings.json).

**NOTE.** In the [Zappa Settings](../../../Downloads/tr-05-serverless-have-i-been-pwned-develop/zappa_settings.json) the value of the
...
make sure that in the [Zappa Settings](../../../Downloads/tr-05-serverless-have-i-been-pwned-develop/zappa_settings.json) the value of the
...
That is why in the [Zappa Settings](../../../Downloads/tr-05-serverless-have-i-been-pwned-develop/zappa_settings.json) the `manage_roles`
...
grouped by different environments in the [Zappa Settings](../../../Downloads/tr-05-serverless-have-i-been-pwned-develop/zappa_settings.json).
