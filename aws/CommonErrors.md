...
some steps/notes from the [AWS HOWTO](HOWTO.md)/[README](../../../Downloads/tr-05-serverless-have-i-been-pwned-develop/README.md). So this
...
`s3_bucket` setting in the [Zappa Settings](../../../Downloads/tr-05-serverless-have-i-been-pwned-develop/zappa_settings.json) to be a
